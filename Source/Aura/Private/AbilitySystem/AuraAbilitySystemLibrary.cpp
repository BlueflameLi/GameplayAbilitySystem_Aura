...
UAttributeMenuWidgetController* UAuraAbilitySystemLibrary::GAttributeMenuWidgetController(
                                                            ...
                                                            UAbilitySystemComponent* ASC)
{
	...
	FCharacterClassDefaultInfo ClassDefaultInfo = CharacterClassInfo->GetCharacterClassDefaultInfo(
		CharacterClass);
